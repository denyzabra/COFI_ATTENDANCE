...
<head>
  ...
  <title>COMMUNITY FIRST - Login</title>
...
<body class="bg-gradient-login" style="background-image: url('img/logo/groupphoto.jpeg');">
  <!-- Login Content -->
          ...
          <div class="card-body p-0">
            <div class="row">
              <div class="col-lg-12">
                ...
                <h5 align="center">COFI ATTENDANCE SYSTEM</h5>
                  <div class="text-center">
                    <img src="img/logo/CoFi.jpg" style="width:100px;height:100px">
                    <br><br>
