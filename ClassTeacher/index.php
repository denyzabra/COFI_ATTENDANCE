      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <h1 class="h3 mb-0 text-gray-800">Class Teacher Dashboard (<?php if (isset($rrw) && is_array($rrw)) {
    // Access elements safely using the null coalescing operator to provide a default value
    $className = isset($rrw['className']) ? $rrw['className'] : '';
    $classArmName = isset($rrw['classArmName']) ? $rrw['classArmName'] : '';

    // Display the Class Teacher Dashboard with class name and arm name
    echo '<h1 class="h3 mb-0 text-gray-800">Class Teacher Dashboard (' . $className . ' - ' . $classArmName . ')</h1>';
} else {
    // Handle the case when $rrw is null or not an array
    echo '<h1 class="h3 mb-0 text-gray-800">Class Teacher Dashboard (Class - Arm)</h1>';
}?>)</h1>
            <ol class="breadcrumb">
